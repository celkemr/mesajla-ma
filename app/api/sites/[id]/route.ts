...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = ['bot_name', 'system_prompt', 'widget_position', 'widget_color', 'widget_welcome_message', 'widget_typing_indicator', 'widget_online_indicator', 'widget_language'];
